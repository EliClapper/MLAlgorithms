...
OLS <- function(y, x){
  ...
  p_vals <- pt(abs(t_vals), dfs, lower.tail = F) * 2 #probability of this t-value against central t-distirbution with Df = dfs two-tailed
  ...
  rownames(estimates) <- sprintf("b%02d", 1:ncol(x))
