...
Lets code. First we create a function that gets the product of the proportions for the predictors
```{r}
...
HistEst <- function(df, breaks = 25){
  ...
  #####
  #We now have the nominator of the bayes classifier. "probs" contains the priors and "prods" contains the products of the proportions of the bins in each predictor. We just need the denominator which is the sum of the prior * those products, so we are almost there...
  #####
